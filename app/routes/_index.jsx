...
const Hero = () => {
  return (
    <section className="container default-section">
      <div className="row">
        <div className="col-xs-12 col-sm-6 d-grid gap-1 XheroImages">
          ...
          <div className="rounded d-flex flex-column justify-content-center align-items-center text-white text-center bg-secondary p-4"><span className="font-size-15"><i className="bi bi-globe2"></i></span><span>Learn to cook anything</span></div>
        </div>
        <div className="col-xs-12 col-sm-6 Xalign-center flex-column">
